...
object suggestions {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(191); 
  ...
  val t = Try(new Exception("error"));System.out.println("""t  : scala.util.Try[Exception] = """ + $show(t ));$skip(36); 
	val obs = Observable.from(1 to 10);System.out.println("""obs  : rx.lang.scala.Observable[Int] = """ + $show(obs ));$skip(20); 
	val obs2 = obs.con;System.out.println("""obs2  : <error> = """ + $show(obs2 ));$skip(40); val res$0 = 
