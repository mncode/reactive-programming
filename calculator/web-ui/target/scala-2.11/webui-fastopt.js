...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var n = x3.name$2;
      var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(n, references);
      var temp$references = $as_sci_Map(references.filter__F1__O(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(n$1) {
        return (function(p$2) {
          var p = $as_T2(p$2);
          var x = p.$$und1$f;
          return (!((x === null) ? (n$1 === null) : $objectEquals(x, n$1)))
        })
      })(n))));
      expr = temp$expr;
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  $as_T(tweetText.apply__O());
  return new $c_Lcalculator_Var().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1) {
    return (function() {
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var remain = $uI(remainingCharsCount$1.apply__O());
      return (((remain >= 15) && (remain <= 140)) ? "green" : (((remain >= 0) && (remain < 15)) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
var $s_sc_MapLike$class__filterNot__sc_MapLike__F1__sc_Map = (function($$this, p) {
...
var $s_sc_TraversableLike$class__filterImpl__p0__sc_TraversableLike__F1__Z__O = (function($$this, p, isFlipped) {
  var b = $$this.newBuilder__scm_Builder();
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(e) {
  var $$this = e.$$und1$f;
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, e$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(e$1.$$und2$f).apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, e));
  var y = new $c_Lcalculator_Var().init___F0(expr);
